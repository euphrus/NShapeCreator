    ...
    internal static class DotNet
    {
        ...
        public static string GetShapeClass(Size canvasSize, GDIShape gdiShape, float multiplier)
        {
            ...
            if (gdiShape != null)
            {
                ...
                sb.AppendLine(tab2 + "{");
                sb.AppendLine(tab3 + "WidthF = " + gdiShape.Width + "F;");
                sb.AppendLine(tab3 + "HeightF = " + gdiShape.Height + "F;");
                sb.AppendLine(tab2 + "}");
                sb.AppendLine("");
        ...
        public static string GetRectangleFBaseClass(Size canvasSize, GDIShape gdiShape, float multiplier)
        {
            ...
            sb.AppendLine(tab2 + "}");
            sb.AppendLine("");
            sb.AppendLine(tab2 + "private new int Width");
            sb.AppendLine(tab2 + "{");
            sb.AppendLine(tab3 + "get");
            sb.AppendLine(tab3 + "{");
            ...
            sb.AppendLine(tab2 + "}");
            sb.AppendLine("");
            sb.AppendLine(tab2 + "private new int Height");
            sb.AppendLine(tab2 + "{");
            sb.AppendLine(tab3 + "get");
            sb.AppendLine(tab3 + "{");
