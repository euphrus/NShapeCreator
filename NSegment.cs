...
namespace NShapeCreator
{
    ...
    public class NSegment : ICloneable
    {
    ...
    public class CubicBezier : NSegment
    {
    ...
    public class Rectangle : NSegment
    {
